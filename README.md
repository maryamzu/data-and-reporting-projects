...
Below you will also find a simple data modelling exercise that is based on a bank account information storing scenario. 
This was created using the https://dbdiagram.io/ tool.
